...
class RayCasting:
    ...
    def ray_cast(self):
        ...
        ray_angle = self.game.player.angle - HALF_FOV - 1e-6  # avoid zero
        ...
        for ray in range(NUM_RAYS):
            ...
            #
            if cos_a > 0:  # checking right
                x_vert, dx = (map_x, dx)
            else:   # checking left (tiny subtraction ensures not checking current tile)
                x_vert, dx = (map_x - 1e-6, -1)
